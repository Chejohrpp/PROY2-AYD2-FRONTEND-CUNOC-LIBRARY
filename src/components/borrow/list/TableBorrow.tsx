...
import { Borrow } from 'src/interface/borrow';

const idOrder = 'idBorrow'; //for order the list
const tableName = 'Prestamos'
const pathHandleEdit = '/borrow/return-borrow/'
type interfaceUse = Borrow
...
export default function TableBorrow({ dataServer }: any) {
                    ...
                    >
                        ...
                        <TableBody>
                            {visibleRows.map((row, index) => {
                                const row_id_user: number = row.idBorrow as number;
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <TableCell align="right">{row.dateBorrow}</TableCell>
                                        <TableCell align="right">{row.state}</TableCell>
                                        <TableCell align="right">{row.priceBorrow}</TableCell>
                                        <TableCell align="right">{row.studentName}</TableCell>
                                        <TableCell align="right">{row.studentCarnet}</TableCell>
