...
const pathHandleEdit = '/student/update-student/'
type interfaceUse = Student
...
export default function TableStudent({ dataServer }: any) {
                            ...
                            {visibleRows.map((row, index) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <TableCell align="right">{row.careerName}</TableCell>
                                        <TableCell align="right">{row.canBorrow ? 'No' : 'Si'}</TableCell>
                                    </TableRow>
                                );
                            })}
                            {emptyRows > 0 && (
