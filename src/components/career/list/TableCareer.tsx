...
import { Career } from 'src/interface/career';

const idOrder = 'idCareer'; //for order the list
const tableName = 'Carreras'
const pathHandleEdit = '/career/update-career/'
type interfaceUse = Career
...
function EnhancedTableToolbar(props: EnhancedTableToolbarProps) {
  ...
  export default function TableCareer({dataServer}: any) {
            ...
            >
              ...
              <TableBody>
                {visibleRows.map((row, index) => {
                  const row_id_user: number = row.idCareer as number;
