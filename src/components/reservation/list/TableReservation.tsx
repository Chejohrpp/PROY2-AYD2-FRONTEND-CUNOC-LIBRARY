...
const tableName = 'Reservaciones'
const pathHandleEdit = '/reservation/update-reservation/'
type interfaceUse = Reservation
...
export default function TableReservation({ dataServer }: any) {
                            ...
                            {visibleRows.map((row, index) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <TableCell align="right">{row.isActivate ? 'Sí' : 'No'}</TableCell>
