...
const idOrder = 'idAuthor'; //for order the list
const tableName = 'Autores'
const pathHandleEdit = '/author/update-author/'
type interfaceUse = Author
...
export default function TableAuthor({ dataServer }: any) {
                    ...
                    >
                        ...
                        <TableBody>
                            {visibleRows.map((row, index) => {
                                const row_id_user: number = row.idAuthor as number;
