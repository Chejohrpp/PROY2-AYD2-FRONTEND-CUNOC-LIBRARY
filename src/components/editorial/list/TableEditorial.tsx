...
import { Editorial } from 'src/interface/editorial';


const idOrder = 'idEditorial'; //for order the list
const tableName = 'Editoriales'
const pathHandleEdit = '/editorial/update-editorial/'
type interfaceUse = Editorial
...
function EnhancedTableToolbar(props: EnhancedTableToolbarProps) {
  ...
  export default function TableEditorial({dataServer}: any) {
            ...
            >
              ...
              <TableBody>
                {visibleRows.map((row, index) => {
                  const row_id_user: number = row.idEditorial as number;
